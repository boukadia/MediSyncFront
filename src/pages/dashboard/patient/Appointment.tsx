...
console.log('userrole',decodedToken);
  ...
  const freeCreneaux = creneaux.filter(function (creneau) {
  ...
  // Handle appointment status tab click
  ...
  const upComingAppointments = myAppointments.filter(function (appointment) {
    return appointment.status === "confirmed";
  });
  const concelledAppointments = myAppointments.filter(function (appointment) {
                  ...
                  <div className="card appointment-card shadow-sm">
                    <div className="card-body">
                      <div className="d-flex gap-3">
                        <div
                          className="bg-primary text-white rounded p-3 text-center"
                          style={{ minWidth: "80px" }}
                        >
                          ...
                          <div className="mt-2">
                            <small>{getYear(appointment.date)}</small>
                          </div>
                        </div>
                ...
                <div className="mb-3">
                  ...
                  {filterDoctors.length === 0 ? (
                    <p className="text-muted">
                      Aucun doctor disponible dans cette spécialité .
                    </p>
                  ) : (
                    <select
                ...
                <div className="row">
                  <div className="col-md-6 mb-3">
                    ...
                    {disponibilites.length === 0 ? (
                      <p className="text-muted">
                        Aucune disponibilité pour ce médecin.
                      </p>
                    ) : (
                      <select
                        value={selectedDisponibiliteId}
                      ...
                      >
                        ...
                        {disponibilites.map((disponibilite) => (
                          <option
                            key={disponibilite._id}
                            value={disponibilite._id}
                          >
