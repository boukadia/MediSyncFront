                                            ...
                                            <tr key={ph._id}>
                                                ...
                                                <td>
                                                    <div className="d-flex gap-1">
                                                        <button className="btn btn-sm btn-outline-warning" onClick={() => toast.info('Edition pharmacie en cours...')}><i className="fas fa-edit"></i></button>
                                                        <button className="btn btn-sm btn-outline-danger" onClick={() => toast.error('Suppression pharmacie en cours...')}><i className="fas fa-trash"></i></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        ))}
