...
const LabSideBar: React.FC<SideBarProps> = ({ isOpen, onClose }) => {
  const handleLogout = () => {
    ...
    <>
      ...
      >
        <div className="d-flex align-items-center gap-2 p-3 border-bottom bg-white">
          ...
          <strong className="text-dark">MediSync Labo</strong>
        </div>
        ...
        <div className="flex-grow-1 p-3 overflow-auto">
          <div className="mb-4">
            ...
            <nav className="nav flex-column gap-1">
              ...
              <a
                href="/dashboard/laboratoire/tests"
                className="nav-link d-flex align-items-center gap-3 px-3 py-2 rounded-3 text-decoration-none text-dark"
              >
                <i className="fas fa-vials text-primary" style={{ width: '18px', textAlign: 'center' }}></i>
                <span>Analyses</span>
              </a>
              <a
                href="/dashboard/laboratoire/orders"
                className="nav-link d-flex align-items-center gap-3 px-3 py-2 rounded-3 text-decoration-none text-dark"
              >
                <i className="fas fa-clipboard-list text-primary" style={{ width: '18px', textAlign: 'center' }}></i>
                <span>Ordres de labo</span>
              </a>
              <a
                href="/dashboard/laboratoire/results"
                className="nav-link d-flex align-items-center gap-3 px-3 py-2 rounded-3 text-decoration-none text-dark"
              >
              ...
              <a
                href="/dashboard/laboratoire/patients"
                className="nav-link d-flex align-items-center gap-3 px-3 py-2 rounded-3 text-decoration-none text-dark"
              >
